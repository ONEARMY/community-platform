...
import { DiscussionContainer, Loader } from '@onearmy.apps/components'
import { Text } from 'theme-ui'

import { transformToUserComments } from '../common/transformToUserComments'
import { MAX_COMMENT_LENGTH } from '../constants'
import { logger } from '../logger'
import { nonDeletedCommentsCount } from '../utils/nonDeletedCommentsCount'
import { useCommonStores } from './hooks/useCommonStores'
import { AuthWrapper } from './AuthWrapper'
import { HideDiscussionContainer } from './HideDiscussionContainer'

import type { IDiscussion, UserRole } from '../models'
