...
import clusterIcon from '../../../../assets/icons/map-cluster.svg'
import AwaitingModerationHighlight from '../../../../assets/icons/map-unpproved-pin.svg'
import { logger } from '../../../../logger'
import Workspace from '../../../../pages/User/workspace/Workspace'

import type { PlatformTheme } from '@onearmy.apps/themes'
import type { MarkerCluster } from 'leaflet'
import type { IMapPin } from '../../../../models/maps.models'
