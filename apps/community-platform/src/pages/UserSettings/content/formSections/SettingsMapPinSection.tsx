...
import { Button, FieldTextarea, MapWithPin } from '@onearmy.apps/components'
import { observer } from 'mobx-react'
import { Box, Flex, Heading, Text } from 'theme-ui'

import { useCommonStores } from '../../../../common/hooks/useCommonStores'
import { MAX_PIN_LENGTH } from '../../../../pages/UserSettings/constants'
import {
  buttons,
  fields,
  headings,
...
export const SettingsMapPinSection = observer((props: IProps) => {
  const { children, toggleLocationDropdown } = props
      ...
      <Box>
        ...
        {state.hasMapPin && !state.showAddressEdit && (
          <>
            ...
            <MapWithPin
              position={userStore.user?.location?.latlng || { lat: 0, lng: 0 }}
              draggable={false}
            />
