              ...
              {(notification.content as unknown as Comment)?.comment && (
                <Box
                  sx={{
                    ...
                    // custom pseudo-elements in theme-ui use the "&::before"/"&::after" syntax
                    '&::before': {
                      content: `"“"`, // open-quote character (left double quotation mark)
                      position: 'absolute',
                      fontSize: '4em',
                      color: 'white',
                      textShadow:
                      ...
                      transform:
                        'translateX(-16px) rotate(-10deg) translateY(-27px)',
                    },
                    '&::after': {
                      content: `"”"`, // close-quote character (right double quotation mark)
                      position: 'absolute',
                      right: '10px',
                      fontSize: '4em',
                      color: 'white',
                      textShadow:
                        '2px 0 #000, -2px 0 #000, 0 2px #000, 0 -2px #000, 1px 1px #000, -1px -1px #000, 1px -1px #000, -1px 1px #000',
                      transform:
                        'translateX(20px) rotate(10deg) translateY(10px)',
                    },
                  }}
                >
