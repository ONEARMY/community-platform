...
<Meta title="Base Components/Comment" component={Comment} />

# Comment

Below you will be able to see how to use and configure a `Comment` component:
...
This is how the comment appears when editable, this state is available to either the comment author or a site admin
...
<Story name="Short text with Link">
  <Comment
    creatorName="example"
    creatorCountry="us"
    isUserVerified={true}
