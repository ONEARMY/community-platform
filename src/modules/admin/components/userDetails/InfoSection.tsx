    ...
    <Box>
        ...
        <Box sx={{mt:5}}>
            ...
            <Field 
                ...
                validateFields={[]}
            />
            <Box sx={{background:'#E2EDF7', width:'100%', mt:2, px:2, py:2, borderRadius:1}}>
                <Text
                    sx={{
                        fontSize: 2,
                        marginTop: 4,
                ...
                >
                    Enter a comma separated list of values. Available roles are: beta tester, verified, admin, and super admin
                </Text>
        ...
        <Box sx={{mt:5}}>
          <Flex sx={{ flexWrap: 'wrap' }}>
            <CoverImages isMemberProfile={isMemberProfile} coverImages={props.userData?.coverImages}/>
          </Flex>
        </Box>
        <Box sx={{mt:5}}>
          <>
