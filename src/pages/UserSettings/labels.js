...
exports.inCompleteProfile = exports.missingData = exports.mapForm = exports.notificationForm = exports.headings = exports.form = exports.fields = exports.buttons = void 0;
exports.buttons = {
...
exports.fields = {
    ...
    country: {
        title: 'Your location',
        description: "Thought about adding yourself to our map? If you do, we'll automatically set this field.",
    },
    coverImages: {
        description: "They're shown at the top your profile and helps us evaluate your account. Make sure the first image shows your space. Best size is 1920x1080.",
    ...
    impact: {
        description: "Let's track our collective positive impact! Add data about your recycling work and show the world the power of a movement of small scale recyclers!",
    ...
    publicContentPreference: {
        ...
        description: "Regardless of your email notifications setting, do you want people to be able to contact you? We'll email you their message whenever they do.",
...
exports.headings = {
    ...
    infos: 'Infos',
    map: {
        description: 'Add yourself to the map as an individual who wants to get started. Find local community members and meetup to join forces and collaborate.',
    ...
    visitors: 'Visitors',
    workspace: {
        description: 'In order to have your pin accepted on our map you have to collect at least 6 stars in the Ally Checklist. Learn more about the Community Program and how you can join.',
        title: 'Your map pin',
    },
};
exports.notificationForm = {
    loading: 'Loading your notification setting',
    successfulSave: 'Notification setting saved successfully - whoop',
};
exports.mapForm = {
    confirmDeletePin: 'If you delete your location now, adding a new map pin in the future might need approving.',
    descriptionMember: "Add yourself to the map with a 'want to get started' pin so people can find you, reach out and collaborate. Make sure to add some contact details to your profile!",
    ...
    needsChanges: 'This map pin has been marked as requiring further changes. Specifically the moderator comments are:',
...
exports.missingData = 'Do you have impact data for this year?';
exports.inCompleteProfile = 'In order to add yourself to the map, you need to complete your profile';
