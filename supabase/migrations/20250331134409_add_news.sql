...
create type "public"."content_types" as enum ('questions', 'projects', 'research', 'news');
...
alter table "public"."subscribers" alter column content_type type "public"."content_types" using content_type::text::"public"."content_types";
